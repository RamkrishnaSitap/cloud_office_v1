...
// new department
const AsyncNewDepartmentComponent = Loadable({
   loader: () => import("Routes/cloud-office/department"),
   loading: () => <RctPageLoader />,
});

// add new department
const AsyncNewDeptComponent = Loadable({
   loader: () => import("Routes/new-modules/dept"),
   loading: () => <RctPageLoader />,
});

// member details
const AsyncMemberDetailsComponent = Loadable({
   loader: () => import("Routes/cloud-office/member-details"),
   loading: () => <RctPageLoader />,
});

// add new user role
const AsyncNewUserRoleComponent = Loadable({
   loader: () => import("Routes/cloud-office/user-role"),
   loading: () => <RctPageLoader />,
});

// add new  member details
/*const AsyncAddMemberDetailsComponent = Loadable({
   loader: () => import("Routes/cloud-office/member-details/add-member-details"),
   loading: () => <RctPageLoader />,
});
*/

const AsyncVendorComponent = Loadable({
   loader: () => import("Routes/cloud-office/vendor"),
   loading: () => <RctPageLoader />
});

const AsyncAddVendorComponent = Loadable({
   loader: () => import("Routes/cloud-office/vendor/add-vendors"),
   loading: () => <RctPageLoader />
});

const AsyncMaterialComponent = Loadable({
   loader: () => import("Routes/cloud-office/material"),
   loading: () => <RctPageLoader />
});

const AsyncSignInComponent = Loadable({
   loader: () => import("Routes/cloud-office/signin"),
   loading: () => <RctPageLoader />
});
...
export {
   ...
   AsyncNewDepartmentComponent,
   AsyncNewDeptComponent,
   AsyncMemberDetailsComponent,
   AsyncNewUserRoleComponent,
  // AsyncAddMemberDetailsComponent,

   AsyncVendorComponent,
   AsyncAddVendorComponent,

   AsyncMaterialComponent,
